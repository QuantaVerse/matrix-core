...
A script is provided that generates commit messages compliant with the conventional commit specification. 
...
### Git Branching Model
As branching model we follow **GitFlow** illustrated as follows.

 ![Gitflow diagram](https://i1.wp.com/lanziani.com/slides/gitflow/images/gitflow_1.png)
 
|Branch|Number|Branch|Life-span|function
|---|---|---|---|---|
